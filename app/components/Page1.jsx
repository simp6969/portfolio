    ...
    <>
      <div className="w-[40%] HeaderText text-right flex justify-center gap-[5px]  flex-col">
        ...
        <div className="flex justify-end gap-[20px]">
          <button
            onClick={() => myRef.current.swiper.slideTo(3)}
            className="bg-[#e8dad7] relative z-10 hover:bg-[#fffff5] duration-700 text-[#0e1424] w-[130px] h-[50px] p-[10px] px-[15px] font-bold text-[19px] rounded-[5px]"
          >
            Contact
          </button>
          <button
            onClick={() => myRef.current.swiper.slideTo(2)}
            className=" w-[130px] pointer-events-auto relative z-10 h-[50px] border-2 border-[#e8dad7] duration-700 hover:bg-[#1e2a4b] rounded-[5px] font-bold text-[19px]"
          >
            Projects
          </button>
        </div>
